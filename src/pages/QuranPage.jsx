...
const QuranPage = () => {
  ...
  const handleInputChange = (e) => {
    ...
    const filteredItems = data.data.filter((surah) =>
  ...
  return (
    <div className="min-h-screen py-10 px-5">
      <Heading
        title="tenangkan hatimu dengan membaca al-qur'an"
        subTitle="Bacalah dengan (menyebut) nama Tuhanmu yang menciptakan."
      />
      ...
      <div className="flex flex-wrap gap-3 justify-center my-10 text-center">
        {isLoading ? (
          ...
          <SurahList suwar={searchItem == "" ? data.data : filteredSurah} />
        )}
      </div>
    </div>
  );
